...
export type PluginDetail = { summary: PluginSummary; manifest: PluginManifest; install_source: PluginInstallSource; installed_dir: string | null; config: JsonValue; granted_permissions: string[]; pending_permissions: string[]; audit_logs: PluginAuditLog[]; runtime_failures: PluginRuntimeFailure[] }
...
export type PluginInstallRemoteInput = { pluginId: string; downloadUrl: string; checksum: string; signature: string | null; publicKey: string | null; source: string | null }
...
export type PluginManifest = { id: string; name: string; version: string; apiVersion: string; runtime: PluginRuntime; hooks: PluginHook[]; permissions: string[]; hostCompatibility: PluginHostCompatibility; entry?: string | null; configSchema?: JsonValue | null; configVersion?: number | null; description?: string | null; author?: JsonValue | null; homepage?: string | null; repository?: JsonValue | null; license?: string | null; checksum?: string | null; signature?: string | null; category?: string | null }
export type PluginMarketIndexInput = { indexJson: string; indexUrl: string | null; signature: string | null }
export type PluginMarketListing = { pluginId: string; name: string; latestVersion: string | null; downloadUrl: string | null; checksum: string | null; signature: string | null; riskLabels: string[]; revoked: boolean; compatible: boolean; updateAvailable: boolean; installBlockReason: string | null }
...
export type PluginRuntime = { kind: "declarativeRules"; rules: string[] } | { kind: "native"; engine: string } | { kind: "wasm"; abiVersion: string; memoryLimitBytes?: number | null }
...
export type ProviderSummary = { id: number; cli_key: string; name: string; base_urls: string[]; base_url_mode: ProviderBaseUrlMode; claude_models: ClaudeModels; availability_test_model: string | null; enabled: boolean; priority: number; cost_multiplier: number; limit_5h_usd: number | null; limit_daily_usd: number | null; daily_reset_mode: DailyResetMode; daily_reset_time: string; limit_weekly_usd: number | null; limit_monthly_usd: number | null; limit_total_usd: number | null; tags: string[]; note: string; created_at: number; updated_at: number; auth_mode: string; oauth_provider_type: string | null; oauth_email: string | null; oauth_expires_at: number | null; oauth_last_error: string | null; source_provider_id: number | null; bridge_type: string | null; stream_idle_timeout_seconds: number | null; upstream_retry_policy_override: UpstreamRetryPolicy | null; api_key_configured: boolean }
export type ProviderUpsertInput = { providerId: number | null; cliKey: string; name: string; baseUrls: string[]; baseUrlMode: ProviderBaseUrlMode; authMode: ProviderAuthMode | null; apiKey: string | null; enabled: boolean; costMultiplier: number; priority: number | null; claudeModels: ClaudeModels | null; availabilityTestModel: string | null; limit5hUsd: number | null; limitDailyUsd: number | null; dailyResetMode: DailyResetMode | null; dailyResetTime: string | null; limitWeeklyUsd: number | null; limitMonthlyUsd: number | null; limitTotalUsd: number | null; tags: string[] | null; note: string | null; sourceProviderId: number | null; bridgeType: string | null; streamIdleTimeoutSeconds: number | null; upstreamRetryPolicyOverride: UpstreamRetryPolicy | null; upstreamRetryPolicyOverrideSpecified?: boolean }
...
export type RequestLogDetail = { id: number; trace_id: string; cli_key: string; session_id: string | null; method: string; path: string; query: string | null; excluded_from_stats: boolean; special_settings_json: string | null; status: number | null; error_code: string | null; duration_ms: number; ttfb_ms: number | null; visible_ttfb_ms: number | null; attempts_json: string; input_tokens: number | null; output_tokens: number | null; total_tokens: number | null; cache_read_input_tokens: number | null; cache_creation_input_tokens: number | null; cache_creation_5m_input_tokens: number | null; cache_creation_1h_input_tokens: number | null; usage_json: string | null; requested_model: string | null; final_provider_id: number; final_provider_name: string; final_provider_source_id: number | null; final_provider_source_name: string | null; cost_usd: number | null; provider_chain_json: string | null; error_details_json: string | null; cost_multiplier: number; created_at_ms: number; created_at: number }
...
export type UpstreamRetryPolicy = { enabled: boolean; status_codes: number[]; transport_errors: UpstreamTransportRetryKind[]; max_retries: number; backoff_ms: number; counts_toward_circuit_breaker: boolean }
