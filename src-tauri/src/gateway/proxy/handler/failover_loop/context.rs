...
pub(super) struct CommonCtxArgs<'a, R: tauri::Runtime = tauri::Wry> {
    ...
    pub(super) codex_request_kind: crate::gateway::proxy::request_context::CodexRequestKind,
    ...
    pub(super) codex_reasoning_guard_continuation_marker_text: &'a str,
    ...
    pub(super) codex_gateway_capacity_error_action: crate::settings::CodexGatewayPolicyAction,
    pub(super) codex_gateway_http_429_action: crate::settings::CodexGatewayPolicyAction,
    pub(super) codex_gateway_first_progress_timeout_ms: u32,
    pub(super) codex_gateway_first_progress_action:
        crate::settings::CodexGatewayFirstProgressAction,
...
impl<'a, R: tauri::Runtime> CommonCtx<'a, R> {
    pub(super) fn new(args: CommonCtxArgs<'a, R>) -> Self {
        Self {
            ...
            codex_reasoning_guard_match_mode: args.codex_reasoning_guard_match_mode,
            ...
            codex_reasoning_guard_stream_action: args.codex_reasoning_guard_stream_action,
            codex_reasoning_guard_continuation_marker_text: args
            ...
            codex_gateway_capacity_error_action: args.codex_gateway_capacity_error_action,
            codex_gateway_http_429_action: args.codex_gateway_http_429_action,
            codex_gateway_first_progress_timeout_ms: args.codex_gateway_first_progress_timeout_ms,
            codex_gateway_first_progress_action: args.codex_gateway_first_progress_action,
            codex_gateway_total_timeout_ms: args.codex_gateway_total_timeout_ms,
...
impl<'a, R: tauri::Runtime> From<CommonCtx<'a, R>> for CommonCtxOwned<'a, R> {
    fn from(ctx: CommonCtx<'a, R>) -> Self {
        Self {
            ...
            codex_reasoning_guard_match_mode: ctx.codex_reasoning_guard_match_mode,
            ...
            codex_reasoning_guard_stream_action: ctx.codex_reasoning_guard_stream_action,
            codex_reasoning_guard_continuation_marker_text: ctx
                .codex_reasoning_guard_continuation_marker_text
                .to_string(),
...
pub(super) struct AttemptCtx<'a> {
    ...
    pub(super) policy_timing: Option<super::layered_policy::AttemptPolicyTiming>,
