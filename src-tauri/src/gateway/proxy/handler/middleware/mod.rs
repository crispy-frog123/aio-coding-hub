...
use crate::gateway::proxy::request_context::{
    effective_first_byte_timeout_secs, CodexRequestKind, RequestContextParts,
};
...
impl<R: tauri::Runtime> ProxyContext<R> {
    ...
    pub(super) fn into_request_context_parts(self) -> RequestContextParts<R> {
        ...
        RequestContextParts {
            ...
            codex_reasoning_guard_match_mode: rs.codex_reasoning_guard_match_mode,
            ...
            codex_reasoning_guard_stream_action: rs.codex_reasoning_guard_stream_action,
            codex_reasoning_guard_continuation_marker_text: rs
            ...
            codex_gateway_capacity_error_action: rs.codex_gateway_capacity_error_action,
            codex_gateway_http_429_action: rs.codex_gateway_http_429_action,
            codex_gateway_latency_guard_enabled: rs.codex_gateway_latency_guard_enabled,
            codex_gateway_first_progress_timeout_ms: rs.codex_gateway_first_progress_timeout_ms,
            codex_gateway_first_progress_action: rs.codex_gateway_first_progress_action,
